...
@co_od.on_message(filter("start"))
async def start(bot: co_od, msg: Message):
...
¤¦ تم انشاء البوت بواسطة [ㅤ𓏺 فرقة واسط  . 🇮🇶 ˼](https://t.me/co_od)""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("⭐ غلس 😴😴⭐", url="https://t.me/wasit_go"),
                    InlineKeyboardButton("🕯 مطور لبوت  🕯", user_id=OWNER_ID)
                ]
            ]
        ),
